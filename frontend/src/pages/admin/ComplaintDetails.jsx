    ...
    <div className="min-h-screen bg-cream py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeInUp} initial="hidden" animate="visible" className="mb-6">
          <Link to="/admin/complaints" className="inline-flex items-center text-brown hover:text-brown/80 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <motion.div variants={fadeInUp} initial="hidden" animate="visible">
              <Card>
                <Card.Header>
                  <h2 className="heading-6 text-charcoal">Manage Complaint</h2>
                </Card.Header>
                <Card.Body>
                  <div className="space-y-4">
                    {/* Status */}
            ...
            {complaint.status !== 'resolved' && complaint.status !== 'closed' && (
              <motion.div variants={fadeInUp} initial="hidden" animate="visible">
                <Card>
                  <Card.Header>
                    <h2 className="heading-6 text-charcoal">Resolve Complaint</h2>
                  </Card.Header>
                  <Card.Body>
                    {!showResolutionForm ? (
                      <Button
            ...
            <motion.div variants={fadeInUp} initial="hidden" animate="visible">
              <Card>
                <Card.Header>
                  <h2 className="heading-6 text-charcoal">User Information</h2>
                </Card.Header>
                <Card.Body>
