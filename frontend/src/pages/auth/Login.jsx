...
import { loginSchema } from "@/schemas/authSchema"; // Import your schema
import { Label } from "../../components/ui/label";
import { Input } from "../../components/ui/input";
import { PasswordInput } from "../../components/ui/PasswordInput"; // Import the toggle component
      ...
      <div className="shadow-input w-full rounded-none bg-white p-4 md:rounded-[15px] md:p-8 dark:bg-black">
        ...
        <form className="my-8" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-8 flex justify-end">
            <a href="#" className="text-sm font-medium text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-200 transition-colors">
              Forgot password?
            </a>
          </div>
